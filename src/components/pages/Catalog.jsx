  ...
  export default function Example() {
    return (
      <div className="bg-white">
        <div className="mx-auto max-w-2xl px-4 py-16 smartphone::px-6 sm:py-24 ">
          <h1 className="text-center text-black text-4xl relative top-[-20px]">Products</h1>
  
          <div className="grid smartphone:grid-cols-1 gap-x-8 gap-y-10 smartphone::grid-cols-2 grid-cols-3  ">
            {products.map((product) => (
              <Link to={"/product"} key={product.id} href={product.href} className="group">
                <div className="aspect-h-1 aspect-w-1 w-full overflow-hidden rounded-lg bg-gray-200 aspect-h-8 aspect-w-7">
                  <img
