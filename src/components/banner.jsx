...
function Banner() {
  return (
 <section className="home h-screen w-full tablet:flex desktop:flex items-center justify-between mx-[100px] my-5 smartphone:my-52 ">
  ...
  <div className="flex space-x-6 smartphone:mt-[-32px]">
